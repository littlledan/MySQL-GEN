...
VALUES("Sacola Cinza", 1118, 0.50, 6);

INSERT INTO tb_produtos(nome, quantidade, preco, categoria_id)
VALUES("Sacola Verde", 1118, 0.50, 6);
...
-- Adicionando criterios especifico
SELECT * FROM tb_produtos WHERE preco IN (5.00, 10.00, 15.00);

SELECT * FROM tb_produtos WHERE preco IN (5.00, 10.00, 15.00) ORDER BY preco ASC;

SELECT * FROM tb_produtos WHERE preco BETWEEN 5.00 AND 15.00;

-- buscar produtos com "te" no final
SELECT * FROM tb_produtos WHERE nome LIKE "%te";
-- buscar produtos com "ra" no começo
SELECT * FROM tb_produtos WHERE nome LIKE "ra%";
-- buscar produtos com "ra" em qualquer lugar da palavra
SELECT * FROM tb_produtos WHERE nome LIKE "%ra%";

-- comandos de junção (inner join, rigth join, left join)

SELECT * FROM tb_produtos;
SELECT * FROM tb_categorias;

-- correlação entre tabelas so com relacionamento
SELECT nome, preco, quantidade, tb_categorias.descricao
FROM tb_produtos 
INNER JOIN tb_categorias
ON tb_produtos.categoria_id = tb_categorias.id
ORDER BY tb_categorias.descricao, nome;

-- correlação entre tabelas so com relacionamento e mostrando tudo de produtos
SELECT nome, preco, quantidade, tb_categorias.descricao
FROM tb_produtos 
...
-- correlação entre tabelas so com relacionamento e mostrando tudo de Categorias
SELECT nome, preco, quantidade, tb_categorias.descricao
FROM tb_produtos 
